...
独立运行：
    python -m app.integrations.mcp_server

也可作为模块导入：
    from app.integrations.mcp_server import create_mcp_server
"""
import logging
import json
import asyncio
...
def create_mcp_server(user_id: Optional[int] = None) -> Server:
    """
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "table_name": {
                            "type": "string",
                            "description": "表名，如 contacts、tasks、projects",
                        },
                        "fields": {
                            "type": "array",
                            "description": "字段定义列表",
